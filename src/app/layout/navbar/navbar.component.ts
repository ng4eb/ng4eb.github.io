import { AfterViewChecked, AfterViewInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ElementRef, OnDestroy, OnInit, Renderer2, ViewChild } from '@angular/core';
...
export class NavbarComponent implements OnInit, AfterViewInit, AfterViewChecked, OnDestroy {
    ...
    ngAfterViewInit() {
        if (this._isPlatformBrowserService.getIsPlatformBrowser()) {
            this._subscription2 = this._layoutService.getSlidingDistance$().subscribe((v) => {
