import { AfterViewInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, HostListener, OnDestroy, OnInit, ViewChildren } from '@angular/core';
import { RoutingService } from '../shared/routing.service';
import { ChapterListingService, navigationPart } from '../shared/chapter-listing-service/chapter-listing.service';
...
export class ArticleComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this._route.queryParamMap.pipe(filter(Boolean), takeUntil(this._destroy$)).subscribe((paramMap) => {
            this.query = paramMap.get('query') || '';
        });
    }

    ngAfterViewInit() {
        this._onLoadMdService
            .getH2Elements()
        ...
        this.currQueryIndex$.pipe(takeUntil(this._destroy$)).subscribe((idx) => {
