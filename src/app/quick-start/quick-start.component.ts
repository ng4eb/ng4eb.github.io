...
export class QuickStartComponent implements OnInit {
    ...
    quickStartContent: Record<string, { title: string; paragraphs: string[] }> = {
        newToAngular: {
        ...
        switch (this.path) {
            ...
            case 'whyThisBook':
                this._seoService.setSEO({
                    title: 'Why This Book',
                    description:
                        'Why this book? Because this book is written with simplicity in mind. It aims to cover the basic knowledge and skills you need to get started in Angular within a short time.',
